...
| `GET /reservas/duplicada` | qualquer autenticado | **sem filtro** — gap conhecido (enumera localizador/viagem de outros vendedores mesmo só com `ViagemVerProprias`); ver "Deferidas da 3.2" em `docs/BACKLOG.md`, tratar em 3.3 | — | — |
