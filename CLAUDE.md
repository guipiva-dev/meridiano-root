...
**Estado (2026-09-11):** Fase 1 (spec v2) ✓ · Fase 2 (esqueleto .NET, migrations 0001–0011, 39 testes) ✓ · Design v1 congelado (tag `design-v1-freeze`) ✓ · Fase 3.0 (hardening: migration 0012, sessão revalidada, `Guardas`; 75 testes) ✓ · Fase 3.1 (scaffold do front, migration 0013, 82 testes backend, 64 testes front) ✓ · Fase 3.2 (Nova viagem: 106 testes API + 21 domínio backend, 123 testes Vitest + Playwright e2e 4/4 front; E2E cronometrado 6,0 s @1280 / 6,4 s @1440) ✓ · Fase 3.3 (Viagens e reservas: migration 0014, 179 testes API + 22 domínio, 237 Vitest + Playwright 8/8 e2e; E2E 4 reservas 6,0 s @1280 / 7,3 s @1440) ✓ · Fases 3.4 (Cadastros: 11 tasks, 5 ondas) e 3.5 (Financeiro: 12 tasks, 4 ondas) ✓ — mergeadas em `main` 2026-09-11 (backend `16d9c65`, frontend `f5a4884`); executadas **em paralelo** sob `docs/superpowers/plans/2026-09-09-fase-3-4-3-5-contrato.md`, migration 0015, 226 testes API + 26 domínio, 402 Vitest + Playwright `cadastros` 4/4 e `financeiro` 4/4; E2E 4 reservas 5,8 s @1280 / 6,3 s @1440 (3.3: 6,0 / 7,3) · Fase 3.6 (Agenda, Relatórios, Equipe, Auditoria, jobs: 13 tasks, 5 ondas, migration 0016, 257 testes API + 30 domínio, 486 Vitest + Playwright `operacao` 8/8 e `nova-viagem` 4/4; E2E 4 reservas 6,2 s @1280 / 7,7 s @1440) ✓ — mergeada em `main` 2026-09-11 (backend `b949e97`, frontend `f6f0ceb`; branches HEAD `04dfba7` / `843667a`) · próximo: Fase 4 (piloto). Migrations 0001–0016. Pendentes humanos (a Fase 3 não fecha sem eles): teste de UX §7 (tempo humano), piloto §12 (três viagens reais × fórmulas), TZ `America/Sao_Paulo` ✓ (Dockerfile, 2026-09-11) — checklist em `docs/BACKLOG.md`.
